...
public class SeeAllPatientFragment extends Fragment {

    private SeeAllPatientViewModel seeAllPatientViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        seeAllPatientViewModel =
                ViewModelProviders.of(this).get(SeeAllPatientViewModel.class);
